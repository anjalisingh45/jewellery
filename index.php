                    ...
                    <div class="offset-md-2 col-md-4">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <p>
                            Choose your jewellery, Select the dates & 
							checkout.Jewellery is delivered at your
							doorstep.
                          </p>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="detail_img-box">
            <img src="images/r3.png" alt="" class="w-100"/>
          </div>
        </div>
        <div class=" col-lg-7">
        ...
        <a href="">
          <div class="product_box">
			...
			<a href="single_product.php?id=<?php echo $row["id"];?>">
              <img src="admin/<?php echo $row["image"];?>" style="width:250px;height:250px;" alt="" />
              <span>
            ...
            <div class="product_detail-box">
              <span>
               MRP:<strike><?php echo $row["price"];?></strike><br/>
Selling Price: <?php echo $row["selling price"];?>
              </span>
              <p>
                Rental Product
              </p>
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <p>
			...
			GET DISCOUNTS, VOUCHER CODES & MORE
          </p>
        </div>
		<form method="post" action="insert_signup.php">
        <div class="col-md-7">
          
            <input type="email"  name="a" placeholder=" Enter your email     " />
